...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Annual Reports", href: "/rend", icon: "📄", module: "Annual Reports" },
  { label: "---", href: "" },
...
const PAGE_TITLES: Record<string, { title: string; subtitle: string }> = {
  ...
  "/rend": { title: "Annual Reports", subtitle: "Annual reports and state renewals — clients flagged for annual filings." },
